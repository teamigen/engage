                            ...
                            <form action="#" id="saveInstitute">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="instituteSlug"
                                        placeholder="Slug of Institute" id="instituteSlug" readonly>
                                </div>
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.success) {
                        ...
                        $('#InstituteMessage').html('<p>Institute Successfully Created!</p>').addClass('alert alert-success');


                        var newRow = '<tr id="row-' + response.instituteId + '">' +
                            '<td>' + formData.get('instituteName') + '</td>' +
                            '<td>' + $('#instituteLocation option:selected').text() + '</td>' +
                            '<td>' +
                            '<a href="<?= base_url("Institutes/edit/") ?>' + formData.get('instituteSlug') + '" class="edit-row" data-id="' + formData.get('instituteSlug') + '"><i class="ri-pencil-line"></i></a>&nbsp;' +
                            '<a href="javascript:void(0);" class="delete-row" data-id="' + response.instituteId + '"><i class="ri-delete-bin-line"></i></a>&nbsp;' +
                            '</td>' +
                            '</tr>';
