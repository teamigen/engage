                                ...
                                <tbody>
                                    <?php foreach ($regions as $rg) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?= base_url('Stations/editRegion/' . ($rg['regionSlug'])) ?>" class="edit-row" data-id="<?= ($rg['regionSlug']) ?>"><i class="ri-pencil-line"></i></a>&nbsp;
                                                <a href="javascript:void(0);" class="delete-row" data-id="<?= ($rg['regionId']) ?>"><i class="ri-delete-bin-line"></i></a>&nbsp;
