                        ...
                        <div class="card-body">
                            ...
                            <p class="card-title-desc">Create a Station if you have region, district & state already
                                ...
                                <div class="form-group m-0" style="text-align:right;">
                                    <button id="savestation_button" class="btn btn-success waves-effect waves-light pull-right"
                                       >Create</button>
                                </div>
                                <script>
 ...
 <script>
        $(document).ready(function() {
            $('#savestation_button').click(function() {
                ...
                $.ajax({
                    url: '<?php echo base_url('stations/savestation'); ?>',  type: 'POST',
                    dataType: 'json',
                    data: { 
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-title-desc">Create a District if you have region & state already
                                ...
                                <div class="form-group m-0" style="text-align:right;">
                                    <button id="savedistrict_button" class="btn btn-success waves-effect waves-light pull-right"
                                       >Create</button>
                                </div>
                                <script>
        $(document).ready(function() {
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-title-desc">Create State if you have country already
                                ...
                                <div class="form-group m-0" style="text-align:right;">
                                    <button id="savestate_button" class="btn btn-success waves-effect waves-light pull-right"
                                        >Create</button>
                                </div>
        ...
        $(document).ready(function() {
            $('#savestate_button').click(function() {
                ...
                $.ajax({
                    url: '<?php echo base_url('stations/savestate'); ?>',  type: 'POST',
                    dataType: 'json',
                    data: { 
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p><span id="savecountry_message"></span></p>
                                ...
                                <div class="form-group m-0" style="text-align:right;">
                                <button id="savecountry_button" class="btn btn-success waves-effect waves-light pull-right"
                                       >Create</button>
                                </div>
        ...
        $(document).ready(function() {
            $('#savecountry_button').click(function() {
                ...
                $.ajax({
                    url: '<?php echo base_url('stations/savecountry'); ?>',  type: 'POST',
                    dataType: 'json',
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p><span id="saveregion_message"></span></p>
                                ...
                                <div class="form-group m-0" style="text-align:right;">
                                    <button id="saveregion_button" class="btn btn-success waves-effect waves-light pull-right"
                                       >Create</button>
                                </div>
