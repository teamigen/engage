                            ...
                            <form action="<?php echo site_url('Weeklygroups/update/' . $group->id); ?>" id="saveGroup" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="groupType" class="form-control select2" id="groupType">
                                        ...
                                        <option value="Evangelistic Group 1"
                                            <?php echo (isset($group->groupType) && $group->groupType == 'Evangelistic Group 1') ? 'selected' : ''; ?>>
                                            Evangelistic Group 1
                                        </option>
                                        <option value="Evangelistic Group 2"
                                            <?php echo (isset($group->groupType) && $group->groupType == 'Evangelistic Group 2') ? 'selected' : ''; ?>>
                                            Evangelistic Group 2
                                        </option>
                                    </select>
                                </div>
