                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                ...
                                <tbody>
                                    <?php if (!empty($cgpfList)) : ?>
                                        <?php foreach ($cgpfList as $cgpf) : ?>
                                            <tr id="row-<?= $cgpf['cgpf_slug'] ?>">
                                                <td><?= $cgpf['cgpf_name'] ?></td>
                                                <td><?= $cgpf['locationName'] ?></td>
                                    ...
                                    <?php else : ?>
                                        <tr>
                                            <td colspan="5">No CGPF data available.</td>
                                        </tr>
                                    <?php endif; ?>
                                </tbody>
                            </table>
