            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0">Edit Area council</h4>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="<?= base_url('Council/updateAreaCouncil') ?>" id="saveStudentCouncil" method="post">
                                <div id="staffMessage"></div>


                                <input type="hidden" name="councilId" value="<?= htmlspecialchars($council['councilId'] ?? '', ENT_QUOTES, 'UTF-8') ?>">
                                <h4 class="card-title">Area Council</h4>
                                <p class="card-title-desc">Edit Area Council</p>
                                <hr>
                                <div class="row">
                                    <div class="col-lg-3">
