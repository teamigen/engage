            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0">Edit District council</h4>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="<?= base_url('Council/updateDistrictCouncil') ?>" id="saveStudentCouncil" method="post">
                                <div id="staffMessage"></div>


                                <input type="hidden" name="councilId" value="<?= htmlspecialchars($council['councilId'] ?? '', ENT_QUOTES, 'UTF-8') ?>">
                                <h4 class="card-title">District Council</h4>
                                <p class="card-title-desc">Edit District Council</p>
                                <hr>
                                <div class="row">
                                    <div class="col-lg-3">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            <label>Area</label>
                                            <input class="form-control" type="text" name="councilArea" id="councilArea" value="<?= $council['councilArea']; ?>" placeholder="councilArea">
                                        </div>
                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" name="memberId[]">
                                                            ...
                                                            <?php foreach ($members as $m): ?>
                                                                <option value="<?= $m['memberId']; ?>" <?= $m['memberId'] == $member['memberId'] ? 'selected' : ''; ?>>
                                                                    <?= $m['memberName']; ?>
                                                                </option>
                                                            <?php endforeach; ?>
...
<script>
    $(document).ready(function() {
        ...
        <div class="form-group">
            ...
            <select id="memberId" class="form-control select2" name="memberId[]">
                <option value="">Select Member</option>
