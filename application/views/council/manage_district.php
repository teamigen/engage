            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0">District Councils</h4>
                                    ...
                                    <?php if (!empty($councils)) : ?>
                                        <?php foreach ($councils as $coucil) : ?>
                                            <tr id="row-<?= ($coucil['councilId']) ?>">
                                                ...
                                                <td>
                                                    <a href="<?= base_url('Council/editDistrict/' . ($coucil['councilSlug'])) ?>" class="edit-row" data-id="<?= ($coucil['councilSlug']) ?>"><i class="ri-pencil-line"></i></a>&nbsp;
        ...
        document.querySelectorAll('.delete-row').forEach(function(deleteButton) {
            ...
            deleteButton.addEventListener('click', function() {
                ...
                if (confirm('Are you sure you want to delete this row?')) {
                    ...
                    fetch('<?= base_url(); ?>Council/deleteDistrict/' + councilId, {
                            method: 'DELETE',
                            headers: {
