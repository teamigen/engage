                    ...
                    <div class="card">
                        <div class="card-body">
                            <form action="#" id="saveAreaCouncil" method="post">
                                ...
                                <p class="card-title-desc">Create New Area Council</p>
                                <hr>
                                <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            <label>Area</label>
                                            <input class="form-control" type="text" name="councilArea" placeholder="Council Area" id="councilArea">
    ...
    <div class="col-lg-6">
      ...
      <div class="col-lg-6">
        ...
        $('#saveAreaCouncil').submit(function(event) {
            ...
            $.ajax({
                url: '<?php echo base_url("Council/insertAreaCouncil"); ?>',
                type: 'POST',
                data: formData,
                processData: false,
                contentType: false,
