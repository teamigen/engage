            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0">Area Councils</h4>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="card-title">LIST OF AREA COUNCILS</h4>
                            <p class="card-title-desc">List of all Area Councils
                            </p>
                            <hr>
                            <div class="row">
                                    ...
                                    <?php if (!empty($councils)) : ?>
                                        <?php foreach ($councils as $coucil) : ?>
                                            <tr id="row-<?= ($coucil['councilId']) ?>">
                                                ...
                                                <!-- <td><?= ($coucil["councilArea"]) ?></td> -->
                                                <td><?= ($coucil["endDate"]) ?></td>

                                                <td>
                                                    <a href="<?= base_url('Council/editArea/' . ($coucil['councilSlug'])) ?>" class="edit-row" data-id="<?= ($coucil['councilSlug']) ?>"><i class="ri-pencil-line"></i></a>&nbsp;
        ...
        document.querySelectorAll('.delete-row').forEach(function(deleteButton) {
            ...
            deleteButton.addEventListener('click', function() {
                ...
                if (confirm('Are you sure you want to delete this row?')) {
                    ...
                    fetch('<?= base_url(); ?>Council/deleteArea/' + councilId, {
                            method: 'DELETE',
                            headers: {
