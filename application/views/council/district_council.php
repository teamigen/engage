        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0">District council</h4>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="#" id="saveAreaCouncil" method="post">
                                <div id="staffMessage"></div>

                                <h4 class="card-title">District Council</h4>
                                <p class="card-title-desc">Create District Council</p>
                                <hr>
                                <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="councilArea" placeholder="Council District" id="councilArea">
...
<script>
    ...
    <?php endforeach; ?>
      ...
      <div class="col-lg-6">
        ...
        $('#saveAreaCouncil').submit(function(event) {
            event.preventDefault();

            var formData = new FormData(this);

            $.ajax({
                url: '<?php echo base_url("Council/insertDistrictCouncil"); ?>',
                type: 'POST',
                data: formData,
                processData: false,
                contentType: false,
