...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 26, 2024 at 01:59 PM
...
(40, 'staff 1', 'staff1-11', 2, 2, 'Station Staff', 'Sreekariyam', '2024-08-21', '2024-08-29', 'staff1', '$2y$10$WdUB4/eNCHX0mcstAvYin.MRzt87c20Fgjam72dlk27WR6daC3L1K', '24755754', '3546875864', '2024-08-21', '2024-08-27');
...
INSERT INTO `staff_family` (`familyId`, `staffId`, `familyName`, `familyRelation`, `familyAge`, `familyOccupation`) VALUES
(81, 40, 'family details', 'Son', 40, 'teacher');
...
--
ALTER TABLE `staff_family`
  MODIFY `familyId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=82;

--
-- AUTO_INCREMENT for table `staff_transfers`
--
ALTER TABLE `staff_transfers`
  MODIFY `transferId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
